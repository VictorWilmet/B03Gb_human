...
Réalisez un rapport d'analyse structuré sur une question de votre choix sur les données de biométrie humaine.
...
- Consignez vos résultats dans un document structuré au format R Markdorwn. Utilisez le template (`human.Rmd`) mis à votre disposition dans le dossier `docs`. Ce document doit contenir : 
